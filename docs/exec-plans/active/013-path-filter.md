...
```bash
omnisess list /Users/example/prj/foo          # absolute path
omnisess list ./prj/foo                     # relative (resolved to absolute)
omnisess list .                             # current directory
omnisess search "sqlite" /Users/example/prj/foo
```
...
an absolute path like `/Users/example/prj/foo` will match any session whose
