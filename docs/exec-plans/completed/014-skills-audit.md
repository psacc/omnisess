...
> 3. Build omnisess on the feature branch (`go build -o /tmp/omnisess .`) and run `/tmp/omnisess skills audit --root ~/prj --format json -o /tmp/audit.json`.
