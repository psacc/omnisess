...
**Example**: Session `5594f717` in `~/.claude/projects/-Users-example-prj-team/` was modified at 14:42:56 (within 2 min at time of test) but does not appear in history.jsonl and is not shown by `sessions active`.
