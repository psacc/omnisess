...
This skill is the public sessions-only version of `/recap`. It does not integrate with Slack, Jira, or Granola. Those integrations belong in a private local skill.
